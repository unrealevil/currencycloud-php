...
namespace CurrencyCloud\Tests\VCR\Conversions;
...
class Test extends BaseCurrencyCloudVCRTestCase
{
    ...
    public function canRetrieveConversionDateChangeQuote(): void
    {
        ...
        $conversionDateChangeQuote = $this->getAuthenticatedClient()->conversions()->retrieveDateChangeQuote(
            'cef197c6-2192-4970-a2cf-d45ee046ae8c',
            '2018-11-06'
        );
        ...
        $this->assertSame(
            ...
            $conversionDateChangeQuote->getNewConversionDate()->format(DateTimeInterface::RFC3339)
        );
        $this->assertSame(
            $dummy['new_settlement_date'],
            $conversionDateChangeQuote->getNewSettlementDate()->format(DateTimeInterface::RFC3339)
        );
    }
    ...
    public function canRetrieveConversionSplitPreview(): void
    {
        ...
        $conversionConversionSplitPreview = $this->getAuthenticatedClient()->conversions()->retrieveSplitPreview(
            'cef197c6-2192-4970-a2cf-d45ee046ae8c',
            '35.46'
        );
