...
{
    public static function extract($data): array
    {
        $delimiter = "";
    ...
    protected static function extractArrayKey($value): array|string
    {
        $dataArrayKey = "";
        // find name=""
    ...
    protected static function extractArrayValue($value): string
    {
        $dataArrayValue = "";
        ...
        if (!empty($values)) {
            ...
            $dataArrayValue = \substr($dataArrayValue, 0, -4);
        }
